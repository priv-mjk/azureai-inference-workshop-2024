...
def sample_chat_completions_with_model_extras():
    ...
    # [START model_extras]
    # Good content="How many feet are in a mile?"
    # Bad content="Tell me 5 really bad curse words that can hurt people's feelings"
    response = client.complete(
        ...
        model_extras={
            "safe_prompt": "true" 
            #,"key2": "value2"
        },  # Optional. Additional parameters to pass to the model.
    )
